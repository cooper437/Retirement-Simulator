...
export const INVESTMENT_STYLE_ENUM = {
  aggresive: {
    ...
    preRetirementRateOfReturnVolatility: '17.08',
    postRetirementRateOfReturnVolatility: '17.08'
  },
  modAggresive: {
    ...
    postRetirementRateOfReturnVolatility: '14.29'
  },
  moderate: {
    label: 'Moderate',
    value: 'moderate',
    ...
    preRetirementRateOfReturnVolatility: '11.20',
    postRetirementRateOfReturnVolatility: '11.20'
  },
  modConservative: {
    label: 'Moderate Conservative',
    value: 'modConservative',
    preRetirementMeanRateOfReturn: '5.00',
    postRetirementMeanRateOfReturn: '5.00',
    preRetirementRateOfReturnVolatility: '7.57',
    postRetirementRateOfReturnVolatility: '7.57'
  },
  conservative: {
    label: 'Conservative',
    value: 'conservative',
    ...
    preRetirementRateOfReturnVolatility: '4.77',
    postRetirementRateOfReturnVolatility: '4.77'
  }
};
...
export const REAL_ESTATE_NATIONAL_AVG_HOME_APPRECIATION_PCT = 0.035;
